...
exports.getDashboardStats = exports.getDashboard = exports.getCampaignInsights = exports.getCampaigns = exports.getAdAccounts = void 0;
...
const getDashboardStats = async (req, res) => {
    try {
        ...
        const trends = (data.data || []).map((day) => {
